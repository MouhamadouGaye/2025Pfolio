...
const Header: React.FC<HeaderProps> = ({ isDarkMode, toggleDarkMode }) => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-0 mt-16 border-b-gray-900  dark:border-b-white border-b-10 border-t-gray-900  dark:border-t-white border-t-2  inset-0 z-50 transition-transform duration-300 ease-in-out transform ${
          isMenuOpen ? "translate-x-0" : "translate-x-full"
