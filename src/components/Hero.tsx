        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
              ...
              <span className="text-teal-600 dark:text-teal-400">Business Strategist</span>
            </h1>
            
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl">
              I'm a software developer with a passion for crafting smart and scalable solutions. 
              With a strong foundation in code and an MBA in Finance, I bring a unique perspective 
              to every project.
            </p>
