...
const Experience = ({
  ...
  return (
    ...
    >
      <img
        src={`/assets/${isDarkMode ? "computer-sce-mgaye.png" : "mouha-the-best-engineer.jpeg"}`}
        alt=""
        className="absolute top-0 left-0 w-full h-full object-cover "
      />
      {/* <div className="absolute w-full h-full left-0 top-2 bottom-0 ">
        <ParticleNetwork />
      </div> */}
            ...
            <div className="relative space-y-8">
              ...
              {EXPERIENCES.map((experience, index) => (
                ...
                >
                  ...
                  <div className="bg-white dark:bg-gray-800 opacity-80 border border-gray-200 dark:border-gray-600 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
                    <div className="mb-4">
